    ...
    public class VersSdkClient : IDisposable
    {
            ...
            ILogger? logger = null)
        {
            ...
            _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd(
                $"vers-sdk/1.20.0 csharp/{Environment.Version} {osDesc}/{arch}");
        ...
        /// <summary>Upsert (additive) labels on a VM.</summary>
        public async Task<JsonElement> UpsertVmLabelsAsync(string vm_id, object? body = null, RequestOptions? options = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary>Replace **all** labels on a VM with the provided map.</summary>
        public async Task<JsonElement> ReplaceVmLabelsAsync(string vm_id, object? body = null, RequestOptions? options = null, CancellationToken cancellationToken = default)
        {
            var path = $"/api/v1/vm/{vm_id}/labels";
            var response = await RequestAsync(
                new HttpMethod("PUT"),
                path,
                body: body,
        ...
        /// <summary>Delete a single label from a VM by name.</summary>
        public async Task<JsonElement> DeleteVmLabelAsync(string vm_id, string label_name, RequestOptions? options = null, CancellationToken cancellationToken = default)
        {
            var path = $"/api/v1/vm/{vm_id}/label/{label_name}";
            var response = await RequestAsync(
                new HttpMethod("DELETE"),
                path,
                options: options,
        ...
        /// <summary></summary>
        public async Task<JsonElement> WhoamiHandlerAsync(RequestOptions? options = null, CancellationToken cancellationToken = default)
        {
            var path = "/api/v1/whoami";
            var response = await RequestAsync(
                new HttpMethod("GET"),
                path,
                options: options,
